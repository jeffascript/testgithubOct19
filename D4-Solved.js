 /* EXERCISE 1 (EXAMPLE)
        ...
        /* EXERCISE 2
            ...
            */
            ...
            // crazySum =(o1,o2)=>{
            //     let result = (o1 == o2) ? o1 +o2 : (o1+o2)*3
            //     return result
            // }
    ...
    */
        ...
        function upperFirst(text) {
            ...
            for (var i = 0; i < wordPieces.length; i++) { //for each word of the sentence
                var word = wordPieces[i].charAt(0).toUpperCase();  //it's making the uppercase of the first letter
                 wordPieces[i] = word + wordPieces[i].substring(1); //replacing it 
            }
        ...
        */
        ...
        function giveMeRandom (n){
            ...
            var firstArray = Array.from({length: n}, () => Math.floor(Math.random() *n));
            return(firstArray)
        }
 ...
 checkArray = (userArray) => { //array as an input param
            var sum=0; //we are setting the sum to 0
            userArray.forEach(element => { //foreach element in the array
    ...
    */
    ...
    function shippingCartTotal(){
            var totalDue=0;
            //ES6+ version
            shoppingCart.forEach(shopCartElem => { //running through each object element by element
        ...
        let shoppingCartTotal = shoppingCart.reduce((accumulator, current) => 
        accumulator + (current.price * current.number), 0);
    ...
    */
        ...
        function addToShoppingCart(newProduct) {
         ...
         /**
         * Alternatively, using Arrow function and Spread Method
         */

        addToShoppingCart =(newObject)=>{
            shoppingCart = [...shoppingCart, newObject];
            return shoppingCart.length;
        };
